...
interface Detail { project:Project; chapters:Chapter[]; logs:LogEntry[]; terms:Term[]; conflicts:Array<{source:string;target:string;chapter:number}>; report?:unknown }
...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <div className="workspace-row">
      ...
      {view==="workspace"&&detail&&<Inspector config={bootstrap?.config} detail={detail} mock={mockClient} busy={busy} onMock={setMockClient} onPolish={savePipeline}/>}
    </div>
...
function Workspace({detail,chapter,chapterIndex,segments,hasMoreSegments,onShowMore,tray,setTray,translating,onTranslate,onExport}:{detail:Detail;chapter:Chapter;chapterIndex:number;segments:Segment[];hasMoreSegments:boolean;onShowMore:()=>void;tray:TrayName;setTray:(t:TrayName)=>void;translating:boolean;onTranslate:()=>void;onExport:(f:"txt"|"epub")=>void}){
